...
[[ -s "/etc/X11/xorg.conf.d/10-trackpoint.conf" ]] && cp /etc/X11/xorg.conf.d/10-trackpoint.conf ./etc/X11/xorg.conf.d
[[ -s "/etc/X11/xorg.conf.d/11-touchpad.conf" ]] && cp /etc/X11/xorg.conf.d/11-touchpad.conf ./etc/X11/xorg.conf.d
