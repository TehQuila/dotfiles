...
sudo cp ./etc/X11/xorg.conf.d/0* /etc/X11/xorg.conf.d # copy mouse/keyboard config
sudo cp ./etc/X11/xorg.conf.d/2* /etc/X11/xorg.conf.d
sudo cp ./etc/X11/xorg.conf.d/99-serverlayout.conf /etc/X11/xorg.conf.d
