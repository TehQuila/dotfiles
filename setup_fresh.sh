...
kill $(ps -U $USER -o pid,comm | awk '/Xorg/{print $1}')
...
echo "Setup Workspace? [y/n]"
read workspace
if [[ "$workspace" -eq "y" ]]; then
   ...
   git clone git@github.com:MarcoGlauser/TheWalkingDev.git $HOME/workspace
